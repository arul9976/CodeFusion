  ...
  return (
    <div>
      <div style={{ height: '100dvh', width: '100dvw', pointerEvents: pointermain, filter: filtermain }} >
        <header style={{ backgroundColor: '#07243D', height: '45px', width: '100dvw', borderBottom: '1px solid #37546D', padding: '0dvw 2dvw', display: 'flex', flexDirection: 'row' }} >
  ...
  return (
    <div style={{ pointerEvents: 'auto', display: display, position: 'absolute', height: '220px', width: '500px', top: '200px', left: '700px', border: '1px solid #37546D', backgroundColor: '#102C47', borderRadius: '10px', boxShadow: '5px 10px 30px rgba(0, 0, 0, 0.5)' }}>
      ...
      <div>
        ...
        <div style={{ color: '#EFE9D5', padding: '5px 30px', width: '100px', border: "3px solid #37546D", borderRadius: '8px', position: 'absolute', top: '160px', left: '240px' }} onClick={() => onClick()}>Cancel</div>
  ...
  return (
    <div style={{ pointerEvents: 'auto', display: display, position: 'absolute', height: '180px', width: '500px', top: '200px', left: '700px', border: '1px solid #37546D', backgroundColor: '#102C47', borderRadius: '10px', boxShadow: '5px 10px 30px rgba(0, 0, 0, 0.5)' }}>
      ...
      <div>
        ...
        <div style={{ color: '#EFE9D5', padding: '5px 30px', width: '100px', border: "3px solid #37546D", borderRadius: '8px', position: 'absolute', top: '120px', left: '240px' }} onClick={() => onClick("")}>Cancel</div>
        <div style={{ color: '#EFE9D5', padding: '5px 30px', width: '100px', border: "3px solid #37546D", borderRadius: '8px', position: 'absolute', top: '120px', left: '370px' }} onClick={handleFinalName}>Done</div>
      </div>
    </div>
  )
};
export default NewFileComp;